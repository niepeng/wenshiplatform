...
public class AddressUtils {  
    ...
    public static void main(String[] args) {  
		...
		String ip = getIpAddr(servletFlowData.getRequest());
		log.error("ipvalue===>" + ip);
		System.out.println("ipvalue===>" + ip);
    		  */
        AddressUtils addressUtils = new AddressUtils();  
//          String ip = "118.213.176.78";  
          String ip = "115.29.176.145";  
          String address = "";  
          try {  
           address = addressUtils.getAddress(ip, "utf-8");  
          } catch (Exception e) {  
              e.printStackTrace();  
          }  
     ...
     * @throws Exception 
     */  
	public String getAddress(String ip, String encoding) throws Exception {
		// http://int.dpool.sina.com.cn/iplookup/iplookup.php?format=json&ip=115.206.117.25
		String path = "http://ip.taobao.com/service/getIpInfo.php?ip=" + ip;
		String returnStr = this.getRs(path, encoding);
     ...
     * @return 
     */  
	public String getRs(String path, String encoding) {
		URL url = null;
